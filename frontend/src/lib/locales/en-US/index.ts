export const enUS = {
  ...
  notes: {
    ...
    emptyDescription: "Notes you create in notebooks will appear here.",
    noMatchesTitle: "No matching notes",
    noMatchesDescription: "Try a different search or filter.",
    loadErrorTitle: "Couldn't load your notes",
    loadErrorDescription: "Refresh to try loading the reading index again.",
    detailErrorTitle: "Couldn't open this note",
    detailErrorDescription: "Refresh to try loading the note again.",
    noContent: "This note has no content.",
    readingTime: "{{minutes}} min read",
    wordCount: "{{count}} words",
    selectTitle: "Choose a note to read",
    selectDescription: "Select a note from your library to open it here.",
  },
  notebooks: {
    title: "Notebooks",
    ...
    workspaceViews: "Notebook workspace views",
    contextPanel: "Notebook context",
    contextTab: "Context",
    sourcesTab: "Sources",
    notesTab: "Notes",
    chatTab: "Chat",
    collapseContext: "Collapse context panel",
    expandContext: "Expand context panel",
  },
  sources: {
    title: "Sources",
    ...
    indexedNote: "Sources are automatically indexed after being added and can be used for answering and searching in notebooks.",
    tileView: "Tile view",
    listView: "List view",
    insights: "Insights",
    yes: "Yes",
  ...
  presets: {
    title: "Presets",
    hint: "Each preset has a title and a prompt. Picking one in a chat fills the input box with the prompt.",
    listTitle: "Preset Prompts",
    createNew: "New Preset",
    noPresets: "No preset prompts yet",
    createOne: "Create a preset prompt to quickly start a chat.",
    titleLabel: "Title",
    titlePlaceholder: "e.g. Summarize the notebook",
    promptLabel: "Prompt",
    promptPlaceholder: "The message that gets inserted into the chat box when this preset is picked.",
    createTitle: "Create preset prompt",
    editTitle: "Edit preset prompt",
    deleteConfirm: "Are you sure you want to delete this preset prompt? This action cannot be undone.",
    createSuccess: "Preset prompt created",
    updateSuccess: "Preset prompt updated",
    deleteSuccess: "Preset prompt deleted",
  },
  searchPage: {
  ...
  models: {
    ...
    thinkingTitle: "Thinking strength",
    ...
    thinkingMax: "Max",
    thinkingUltra: "Ultra",
    thinkingSaved: "Thinking strength saved",
  },
  apiKeys: {
    pageTitle: "Models",
