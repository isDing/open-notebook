...
export const zhCN = {
  ...
  notes: {
    ...
    emptyTitle: "暂无笔记",
    emptyDescription: "你在笔记本中创建的笔记会显示在这里。",
    noMatchesTitle: "没有匹配的笔记",
    noMatchesDescription: "请尝试其他搜索词或筛选条件。",
    loadErrorTitle: "笔记加载失败",
    loadErrorDescription: "刷新后再次加载阅读索引。",
    detailErrorTitle: "无法打开这篇笔记",
    detailErrorDescription: "刷新后再次加载笔记。",
    noContent: "这篇笔记没有内容。",
    readingTime: "阅读约 {{minutes}} 分钟",
    wordCount: "{{count}} 字",
    selectTitle: "选择一篇笔记开始阅读",
    selectDescription: "从笔记库中选择一篇笔记，在这里打开。",
  },
  notebooks: {
    title: "笔记本",
    pageDescription: "管理来源与笔记，并与它们对话。",
    newNotebook: "创建笔记本",
    ...
    lastViewed: "查看于{{time}}",
    backToNotebooks: "返回笔记本列表",
    notebookActions: "笔记本操作",
    workspaceViews: "笔记本工作区视图",
    contextPanel: "笔记本上下文",
    contextTab: "上下文",
    sourcesTab: "来源",
    notesTab: "笔记",
    chatTab: "聊天",
    collapseContext: "折叠上下文面板",
    expandContext: "展开上下文面板",
  },
  sources: {
    newSource: "新建来源",
    bulkContext: "上下文",
    ...
    indexed: "已索引",
    notIndexed: "未索引",
    indexedNote: "来源会在添加后自动建立索引，可用于笔记本问答与搜索。",
    tileView: "卡片视图",
    listView: "列表视图",
    insights: "见解",
    yes: "是",
  ...
  presets: {
    title: "预置提示词",
    hint: "每条预置包含一个标题和一段提示词。在对话中选择某条时，输入框会被填入对应的提示词。",
    listTitle: "预置提示词",
    createNew: "新建预置",
    noPresets: "还没有预置提示词",
    createOne: "创建一条预置提示词，快速开始对话。",
    titleLabel: "标题",
    titlePlaceholder: "例如：总结这个笔记本",
    promptLabel: "提示词",
    promptPlaceholder: "选择该预置时填入对话框的消息内容。",
    createTitle: "新建预置提示词",
    editTitle: "编辑预置提示词",
    deleteConfirm: "确定要删除这条预置提示词吗？此操作无法撤销。",
    createSuccess: "预置提示词已创建",
    updateSuccess: "预置提示词已更新",
    deleteSuccess: "预置提示词已删除",
  },
  searchPage: {
    pageTitle: "提问与搜索",
    pageDescription: "向知识库提问，或检索具体内容。",
    askBeta: "提问 (beta)",
    search: "搜索",
  ...
  settings: {
    pageTitle: "设置",
    pageDescription: "处理、搜索与文件管理的偏好设置。",
  ...
  models: {
    ...
    thinkingMax: "最大",
    thinkingUltra: "极限",
    thinkingSaved: "思考强度已保存",
  },
  apiKeys: {
    pageTitle: "模型",
    pageDescription: "接入 AI 提供商并选择默认模型。",
