...
export const zhTW = {
  ...
  notes: {
    ...
    sortOldest: "最早更新",
    emptyTitle: "暫無筆記",
    emptyDescription: "你在筆記本中建立的筆記會顯示在這裡。",
    noMatchesTitle: "沒有符合的筆記",
    noMatchesDescription: "請嘗試其他搜尋詞或篩選條件。",
    loadErrorTitle: "筆記載入失敗",
    loadErrorDescription: "重新整理後再次載入閱讀索引。",
    detailErrorTitle: "無法開啟這篇筆記",
    detailErrorDescription: "重新整理後再次載入筆記。",
    noContent: "這篇筆記沒有內容。",
    readingTime: "閱讀約 {{minutes}} 分鐘",
    wordCount: "{{count}} 字",
    selectTitle: "選擇一篇筆記開始閱讀",
    selectDescription: "從筆記庫中選擇一篇筆記，在這裡開啟。",
  },
  notebooks: {
    title: "筆記本",
    newNotebook: "新增筆記本",
